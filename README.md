...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Alphabytes-global/openclawcli/main/openclaw.sh)
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/byJoey/openclawcli/main/openclaw.sh -o openclaw.sh
chmod +x openclaw.sh
./openclaw.sh
```
...
```powershell
powershell -ExecutionPolicy Bypass -Command "irm https://raw.githubusercontent.com/Alphabytes-global/openclawcli/main/openclaw.ps1 | iex"
```
...
```powershell
Invoke-WebRequest -Uri https://raw.githubusercontent.com/Alphabytes-global/openclawcli/main/openclaw.ps1 -OutFile openclaw.ps1
.\openclaw.ps1
```
